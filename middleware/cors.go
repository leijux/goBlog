...
func Cors() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// if headerStr != "" {
		//     headerStr = fmt.Sprintf("access-control-allow-origin, access-control-allow-headers,Authorization, %s", headerStr)
		// } else {
		//     headerStr = "access-control-allow-origin, access-control-allow-headers"
		// }
		headerStr := fmt.Sprintln("access-control-allow-origin, access-control-allow-headers,Authorization")
		if origin != "" {
